<template>
  <div class="box">
      ...
      <div class="content">
          ...
          <div class="my-search clear">
            <div class="my-searchbar-inner left clear">
              ...
              <div class="my-search-input left">
                <input type="search" placeholder="请输入想找的楼盘名称"
                       @focus="isShowSearch=true;isShowHouseType=false;filterType=''" v-model="communityName">
              </div>
        ...
        <div class="house-box">
          ...
          <div v-if="houseLists.length>0" class="house-list-box" @click="boxClick">
            ...
            <p v-if="!isLoadAll" class="loading-more"><span class="loading-more-span"><i
              class="icon iconfont loading-more-icon">&#xe6ae;</i></span><span class="loading-more-text">加载更多</span></p>
    ...
    <ul class="more-ul" v-if="morePopVisible">
      ...
      <li @click="morePopVisible=false">
        <router-link :to="{name:'myCare'}"><span><i class="icon iconfont my-care">&#xe609;</i></span>我的关注</router-link>
      </li>
      <li @click="morePopVisible=false">
        <router-link :to="{name:'lookHouseIndex'}"><span><i class="icon iconfont look-house">&#xe610;</i></span>看房预约
        </router-link>
      </li>
      <li @click="morePopVisible=false">
        <router-link :to="{name:'signSearch'}"><span><i class="icon iconfont sign-search">&#xe60b;</i></span>签约查询
        </router-link>
      </li>
    </ul>
    <!--全屏遮罩-->
